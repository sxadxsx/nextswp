                      ...
                      <div className="header-content-wrapper---brix">
                          ...
                          <div className="header-right-side">
                              ...
                              <div className="hamburger-menu-wrapper w-nav-button">
                                  <div
                                      style={{
                                          WebkitTransform: "translate3d(0, 0px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0deg) skew(0, 0)",
                                          MozTransform: "translate3d(0, 0px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0deg) skew(0, 0)",
                                          msTransform: "translate3d(0, 0px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0deg) skew(0, 0)",
              ...
              <div className="home-benefits_component">
                  ...
                  <div className="home-benefits_wrapper margin-top">
                      <div
                          ...
                          style={{
                              WebkitTransform: "translate3d(0, 70px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)",
                              MozTransform: "translate3d(0, 70px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)",
                              msTransform: "translate3d(0, 70px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)",
